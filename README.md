...
[scripts/normalization/normalize.py](scripts/normalization/normalize.py) With already clustered data, this script will normalize the trajectory data between $[0,1]$ using the Min-Max Normalization. 
